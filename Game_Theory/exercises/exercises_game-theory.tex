...
\begin{exercise}{3.2}
	...
	\begin{response}\\
		...
		\begin{istgame}[sloped,font=\tiny]
			...
			\istb*{l}[above, near end]{\text{Lee wins}}
			\istb*{r}[above, near end]{\text{Lee wins}}
			\istb*{j}[above, near end]{\text{Lee wins}}
			\endist
			\istrooto(x5)(x1-2){S}+{30.5mm}..{0.45cm}+
			\istb*{l}[above, near end]{\text{Lee wins}}
			\istb*{r}[above, near end]{\text{Rebecca wins}}
			\istb*{j}[above, near end]{\text{None}}
			\endist
			\istrooto(x6)(x1-3){S}+{30.5mm}..{0.45cm}+
			\istb*{l}[above, near end]{\text{Lee wins}}
			\istb*{r}[above, near end]{\text{None}}
			\istb*{j}[above, near end]{\text{John wins}}
			\endist
		\end{istgame}
...
\begin{exercise}{3.4}
	...
	\begin{response}\\
		...
		\begin{istgame}[sloped,font=\tiny]
			...
			\istb{\text{(Andrew,James)}}[above]
			\istb{\text{(Andrew,John)}}[above]
			\istb{\text{(James,John)}}[above]
			\endist
			\xtShowEndPoints[oval node, minimum size=6pt]
			\xtdistance{30mm}{8mm}
			\istrooto(x1)(x0-1){\text{Andrew}}
			\istb{\text{I}}[above]
			\istb{\text{II}}[above]
			\endist
			\istrooto(x2)(x0-2){\text{Andrew}}
			\istb{\text{I}}[above]
			\istb{\text{II}}[above]
			\endist
			\istrooto(x3)(x0-3){\text{James}}
			\istb{\text{I}}[above]
			\istb{\text{II}}[above]
			\endist
			\istrooto(x4)(x1-1){\text{James}}+{10mm}..{0.3cm}+
			\istb*{\text{I}}[above]{\text{I accepted}}
			\istb*{\text{II}}[b]{\text{both rejected}}
			\endist
			\istrooto(x5)(x1-2){\text{James}}+{10mm}..{0.3cm}+
			\istb*{\text{I}}[above]{\text{both rejected}}
			\istb*{\text{II}}[b]{\text{II accepted}}
			\endist
			\istrooto(x6)(x2-1){\text{John}}+{10mm}..{0.3cm}+
			\istb*{\text{I}}[above]{\text{I accepted}}
			\istb*{\text{II}}[b]{\text{both rejected}}
			\endist
			\istrooto(x7)(x2-2){\text{John}}+{10mm}..{0.3cm}+
			\istb*{\text{I}}[above]{\text{both rejected}}
			\istb*{\text{II}}[b]{\text{II accepted}}
			\endist
			\istrooto(x8)(x3-1){\text{John}}+{10mm}..{0.3cm}+
			\istb*{\text{I}}[above]{\text{I accepted}}
			\istb*{\text{II}}[b]{\text{both rejected}}
			\endist
			\istrooto(x9)(x3-2){\text{John}}+{10mm}..{0.3cm}+
			\istb*{\text{I}}[above]{\text{both rejected}}
			\istb*{\text{II}}[b]{\text{II accepted}}
			\endist
		\end{istgame}
...
\begin{exercise}{3.6}
	...
	\begin{response}
		...
		% The total number of strategies that a player get, in a single-player game, in which each player's vertex $ x_{1} \in V_{1} $ contains $m_{x_{1}}$ actions, is $ \prod_{i=1}^{k} m_{x_{i}}$.\\
		% To prove the above statement, first we consider the case where $ V_{1} = \{x_{0}\} $, which trivially implies that the player has $ m_{x_{0}} $ strategies.
		% If $ V_{1} = \{x_{j}\}_{j=0}^{k} $, then by the inductive hypothesis, if $ V_{1} = \{x_{0}\} $, then we get
	\end{response}
\end{exercise}
